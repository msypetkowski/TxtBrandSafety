...
We consider ads banned if the compatibility value is below 0.25.
Best ad is defined as an ad with highest compatibility.
Summary results are shown in table \ref{table:testResults}.
...
\begin{center}
    \begin{tabular}{|l|l|l|l|l|l|l|l|l|l|l|}
    \hline
        First experiment Best ad accuracy:  &
        0.9 \\
        First experiment Banned ads accuracy: &
        1.0 \\
    \hline
        Second experiment Best ad accuracy: &
        0.9 \\
        Second experiment Banned ads accuracy: &
        0.9 \\
    \hline
        Third experiment Best ad accuracy: &
        0.9 \\
        Third experiment Banned ads accuracy: &
        0.85 \\
    \hline
    \end{tabular}
\end{center}
